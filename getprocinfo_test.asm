...
int main(void)
{
  ...
  14:	6a 0c                	push   $0xc
  16:	e8 95 06 00 00       	call   6b0 <malloc>
  ...
  26:	e8 25 04 00 00       	call   450 <printf>
	...
	max_pid =  get_max_pid();
  2b:	e8 5a 03 00 00       	call   38a <get_max_pid>
	for(i = 0; i <= max_pid; i++) {
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	78 3c                	js     73 <main+0x73>
  37:	8d 78 01             	lea    0x1(%eax),%edi
  ...
  43:	56                   	push   %esi
  44:	53                   	push   %ebx
  45:	e8 48 03 00 00       	call   392 <get_proc_info>
  4a:	83 c4 10             	add    $0x10,%esp
  4d:	85 c0                	test   %eax,%eax
  4f:	78 1b                	js     6c <main+0x6c>
			continue;

		printf(1, "%d      %d       %d   %d\n", i, p->ppid, p->psize, p->numberContextSwitches);
  51:	83 ec 08             	sub    $0x8,%esp
  54:	ff 76 08             	pushl  0x8(%esi)
  57:	ff 76 04             	pushl  0x4(%esi)
  5a:	ff 36                	pushl  (%esi)
  5c:	53                   	push   %ebx
  5d:	68 dc 07 00 00       	push   $0x7dc
  62:	6a 01                	push   $0x1
  ...
  71:	75 cd                	jne    40 <main+0x40>
	...
	exit();
  73:	e8 5a 02 00 00       	call   2d2 <exit>
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb f6 07 00 00       	mov    $0x7f6,%ebx
        while(*s != 0){
